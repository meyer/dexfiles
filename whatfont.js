...
function _whatFont() {
	...
	css = {
		...
		// CSS_URL: "http://meyer.github.io/WhatFont/whatfont.min.css?ver=" + VER,
		LINK: null,
	...
	fs = {
		...
		typekit: function() {
			/*
			Code for typekit, based on https://github.com/typekit/typekit-api-examples/blob/master/bookmarklet/bookmarklet.js
			*/
			function findKitId() {
				// Find Typekit ID
				var kitId = null;
